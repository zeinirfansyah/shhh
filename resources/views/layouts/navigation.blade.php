  ...
  <div class="max-w-7xl mx-auto">
    <nav class="Navbar md:flex justify-start gap-20 items-center py-6 mx-4">
      <ul class="flex items-center justify-between">
        <li>
          <a id="brand" href="/">
            <h1 class="text-xl font-semibold  transition-all duration-500">
              <span class="text-[#00C0E6]">Sh</span>hh.
            </h1>
          </a>
        </li>
      ...
      <div id="menu" class="hidden md:flex flex-row justify-between items-center w-full">
        ...
        @guest
          <ul class="md:flex gap-5">
            @if (Route::has('login'))
              <li class="my-5 md:my-0">
                <a href="{{ route('login') }}" class="hover:text-[#00C0E6] transition-all duration-500">Login</a>
              </li>
            @endif

            @if (Route::has('register'))
              <li class="my-5 md:my-0">
                <a href="{{ route('register') }}" class="hover:text-[#00C0E6] transition-all duration-500">Register</a>
              </li>
            @endif
          </ul>
        @else
